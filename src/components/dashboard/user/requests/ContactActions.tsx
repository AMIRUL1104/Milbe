...
export function ContactActions({ phone }: ContactActionsProps) {
  ...
  return (
    <div className="flex items-center max-sm:gap-3 gap-1 shrink-0">
      <a
        href={`tel:${phone}`}
      ...
      <button
        ...
        className="inline-flex h-7 w-7 items-center justify-center rounded-md border border-border bg-surface text-text-muted transition-colors hover:bg-background hover:text-text-primary max-sm:text-text-primary"
