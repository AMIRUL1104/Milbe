...
const labelBase = "block text-xs font-bold text-text-secondary uppercase tracking-wider mb-1.5";
  ...
  return (
    <div className="border border-border-light bg-surface-hover rounded-card p-4">
      ...
      <div className="space-y-3.5">
        {/* Book Name & Publisher - Grid layout */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
          <div>
            <label className={labelBase}>
              বইয়ের নাম <span className="text-danger font-semibold">*</span>
            </label>
          ...
          <div>
            <label className={labelBase}>প্রকাশনীর / লেখকের নাম</label>
            <div className="relative">
              <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-text-muted pointer-events-none">
        ...
        {/* Condition & Price - Always side by side (2 Columns) */}
        <div className="grid grid-cols-2 gap-3.5 items-start">
          <div>
            <label className={labelBase}>
              বইয়ের অবস্থা <span className="text-danger font-semibold">*</span>
            </label>
            <ConditionPills
          ...
          {postType === "sell" && (
            <div>
              <label className={labelBase}>
                মূল্য (৳) <span className="text-danger font-semibold">*</span>
              </label>
              <div className="relative">
                <span className="absolute left-3.5 top-1/2 -translate-y-1/2 font-en font-semibold text-text-secondary text-sm pointer-events-none">
                  ৳
                </span>
                <input
                  type="number"
                  ...
                  className={`${inputBase} pl-8 ${borderClass(!!bookErrors?.price)}`}
                />
              </div>
              {bookErrors?.price && (
