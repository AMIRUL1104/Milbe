...
export default function RequestBookModal({
  ...
  return (
    <div
      className="fixed inset-0 z-100 flex items-center justify-center p-3 sm:p-4 md:p-6 bg-slate-900/60 backdrop-blur-sm transition-all animate-in fade-in duration-200"
      onClick={(e) => {
    ...
    >
      ...
      <div className="relative w-full max-w-lg bg-white rounded-2xl sm:rounded-3xl border border-slate-100 shadow-2xl overflow-hidden flex flex-col max-h-[80vh] sm:max-h-[75vh] animate-in zoom-in-95 duration-200">
